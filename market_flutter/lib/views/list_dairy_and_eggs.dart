...
class ListDairyAndEggs extends StatefulWidget {

  @override
  _ListDairyAndEggsState createState() => _ListDairyAndEggsState();
}

class _ListDairyAndEggsState extends State<ListDairyAndEggs> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Laticínios e Ovos'),),
        body: RefreshIndicator(
          onRefresh: _reloadList,
          child: FutureBuilder(
            future: this._repository.whereDairyAndEggs(),
