...
class ListVegetablesAndLegumes extends StatefulWidget {

  @override
  _ListVegetablesAndLegumesState createState() =>
      _ListVegetablesAndLegumesState();
}

class _ListVegetablesAndLegumesState extends State<ListVegetablesAndLegumes> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Verduras e Legumes'),),
        body: RefreshIndicator(
          onRefresh: _reloadList,
          child: FutureBuilder(
            future: this._repository.whereVegetablesAndLegumes(),
