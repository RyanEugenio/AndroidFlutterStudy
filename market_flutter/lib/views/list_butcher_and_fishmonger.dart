...
class ListButcherAndFishmonger extends StatefulWidget {

  @override
  _ListButcherAndFishmongerState createState() =>
      _ListButcherAndFishmongerState();
}

class _ListButcherAndFishmongerState extends State<ListButcherAndFishmonger> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Açougue e Peixaria'),),
        body: RefreshIndicator(
          onRefresh: _reloadList,
          child: FutureBuilder(
            future: this._repository.whereButcherAndFishmonger(),
