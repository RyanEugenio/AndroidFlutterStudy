...
class ListHygiene extends StatefulWidget {

  @override
  _ListHygieneState createState() => _ListHygieneState();
}

class _ListHygieneState extends State<ListHygiene> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Higiene'),),
        body: RefreshIndicator(
          onRefresh: _reloadList,
          child: FutureBuilder(
            future: this._repository.whereHygiene(),
